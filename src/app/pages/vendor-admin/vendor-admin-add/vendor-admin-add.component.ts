...
@Component({
    selector: 'app-vendor-admin-add',
    templateUrl: './vendor-admin-add.component.html',
    styleUrls: ['./vendor-admin-add.component.scss']
})
export class AddVendorAdminComponent implements OnInit, OnDestroy {
    ...
    createVendor() {
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are going create a vendor!',
            icon: 'warning',
                        ...
                        this.service.post(data, '/v1/vendor/add_vendor/').subscribe(
                            (response) => {
                                ...
                                if (response.code === '200') {
                                    this.router.navigateByUrl('/vendor-admin');
                                    // Reset the form
                                    this.myForm.reset();
